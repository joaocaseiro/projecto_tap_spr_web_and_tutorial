...
public class AppModule {
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(CelebrityService.class, CelebrityServiceImpl.class);
		binder.bind(DistrictService.class, DistrictServiceImpl.class);
		binder.bind(CountyService.class, CountyServiceImpl.class);
		binder.bind(ParishService.class, ParishServiceImpl.class);
